        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          ...
          <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
            <div style={{ display: 'flex', gap: 4 }}>
              {botUsername && <button onClick={() => window.open(`https://t.me/${botUsername}?start=${encodeURIComponent(username)}`, '_blank')} title="Buka Bot Telegram" style={{ width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 10, border: 'none', background: '#2AABEE', color: '#fff', cursor: 'pointer', boxShadow: '0 2px 8px rgba(42,171,238,0.4)', transition: 'transform 0.15s ease' }} onMouseEnter={e => e.currentTarget.style.transform='scale(1.1)'} onMouseLeave={e => e.currentTarget.style.transform='scale(1)'}>
